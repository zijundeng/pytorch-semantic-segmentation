...
exp_name = 'unet_cityscapes224*448'
...
train_args = {
    ...
    'lr': 1e-5,
    'weight_decay': 5e-4,
    'snapshot': 'epoch_485_loss_1.1032_mean_iu_0.3496_lr_0.00010000.pth',  # empty string denotes initial training, otherwise it should be a string of snapshot name
    'print_freq': 50,
...
def validate(val_loader, net, criterion, optimizer, epoch, restore):
    ...
    if val_loss < train_record['best_val_loss']:
        ...
        snapshot_name = 'epoch_%d_loss_%.4f_mean_iu_%.4f_lr_%.8f' % (
            epoch + 1, val_loss, mean_iu, train_args['lr'])
